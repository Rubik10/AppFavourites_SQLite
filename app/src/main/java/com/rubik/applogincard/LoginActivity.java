package com.rubik.applogincard;
...
import com.rubik.applogincard.model.Users;
    ...
    public class LoginActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            initDatabase();     /* Create the the db and his Tables. Also create a instance from controls the behavior of
        ...
        */
        ...
        private void initTestData() {
            ...
            imagesSQL.addImage(new Images("Suicide Squad", "http://ia.media-imdb.com/images/M/MV5BOTY1MzU1MDQ1MF5BMl5BanBnXkFtZTgwNjAzMjY3NzE@._V1_.jpg", 1));
            ...
            imagesSQL.addImage(new Images("Inception", "http://ia.media-imdb.com/images/M/MV5BMjAxMzY3NjcxNF5BMl5BanBnXkFtZTcwNTI5OTM0Mw@@._V1_UX182_CR0,0,182,268_AL_.jpg", 1));
            imagesSQL.addImage(new Images("Star Wars: Episode VII", "http://ia.media-imdb.com/images/M/MV5BOTAzODEzNDAzMl5BMl5BanBnXkFtZTgwMDU1MTgzNzE@._V1_SY1000_CR0,0,677,1000_AL_.jpg", 1));
            ...
            imagesSQL.addImage(new Images("The Leftovers", "http://ia.media-imdb.com/images/M/MV5BMTQ4MzEzNTAxOF5BMl5BanBnXkFtZTgwMjQ1MTY3NjE@._V1_UX182_CR0,0,182,268_AL_.jpg", 2));
